#ifndef _LIBQ_ASTRO_ASTROLOGY_H
#define _LIBQ_ASTRO_ASTROLOGY_H
#ifdef __cplusplus
extern "C" {
#endif
...
/** ASTRO_FACTORS */
enum {
    ASTRO_RULER_PLANET  = 1,
    ASTRO_RULER_HOUSE   = 1<<1,
    ASTRO_ASCENDING     = 1<<2,
    ASTRO_ANGULAR       = 1<<3,
    ASTRO_MRECEPTIVE    = 1<<4,
    ASTRO_NUM_FACTORS = 5
};
