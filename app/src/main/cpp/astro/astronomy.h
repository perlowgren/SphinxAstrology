#ifndef _LIBQ_ASTRO_ASTRONOMY_H_
#define _LIBQ_ASTRO_ASTRONOMY_H_
#ifdef __cplusplus
extern "C" {
#endif

/**
 * Most astronomic calculations are based on Moshier's aa-56
 * project (astronomical almanac), which may be found here:
 * http://www.moshier.net
 *
 * Quite a lot has been changed and modified.
 */
...
typedef struct _astronomy_planet astronomy_planet;
typedef struct _astronomy astronomy;

struct _astronomy_planet {
...
struct _astronomy {
    ...
    double mphase;   //!< Moon phase
    double mphased;  //!< Days per degree of phase angle
};
...
#endif
#endif /* _LIBQ_ASTRO_ASTRONOMY_H_ */
