...
public class ArabicPartsView extends HoroscopeView {
    ...
    public ArabicPartsView(Context context,AttributeSet attrs) { super(context,attrs); }

    public ArabicPartsView(Context context,AttributeSet attrs,int defStyle) { super(context,attrs,defStyle); }

    public ArabicPartsView(Context context,AttributeSet attrs,int defStyle,int defStyleRes) { super(context,attrs,defStyle,defStyleRes); }
